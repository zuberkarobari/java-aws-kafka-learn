...
3. **Secrets Prevention**: Never commit credentials, Firebase API keys, or AWS keys to Git. Keep credentials in `js/firebase-config.local.js` (git-ignored) for local development, and load config dynamically using placeholder fallbacks.
